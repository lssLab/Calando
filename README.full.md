...
<p align="center">
  <strong>English</strong> · <a href="README.full.ko.md">한국어</a>
</p>
...
[adaptive stopping distance](docs/testing/stopping-distance.md).
...
See [architecture and runtime topology](docs/guides/architecture.md) for the complete
...
its own PID space. See [Codex Desktop App](docs/guides/codex-app.md) for the full
safety conditions.
...
- When the App Server or CLI runs in another WSL distribution, virtual machine,
  ...
  [platform and multi-environment behavior](docs/guides/platforms.md) for the boundary.
...
sample. See [performance measurements](docs/guides/performance.md) for the detailed
...
[platform and multi-environment behavior](docs/guides/platforms.md) for setup details.
...
[notification setup](docs/guides/notifications.md) for route selection and removal,
...
`memory-status --connections`. See the [Claude Code guide](docs/guides/usage-claude.md)
and [Codex guide](docs/guides/usage-codex.md) for the detailed differences.
...
[security and data/control boundaries](docs/guides/security.md) for the complete list
...
plus deterministic simulation. See [Test coverage](docs/testing/test-matrix.md).

## Documentation

| Guide | Use it for |
| --- | --- |
| [All documentation](docs/README.md) | Find installation, usage, security-boundary, and public test documents |
| [Architecture](docs/guides/architecture.md) | Background monitoring, before-start checks, state files, and program control |
| [Codex Desktop App](docs/guides/codex-app.md) | Logical conversations, blind control, and recovery inside the shared App Server |
| [Adaptive stopping distance](docs/testing/stopping-distance.md) | Calculation, measured boundaries, gradual braking, and recovery |
| [Platforms and multi-environment behavior](docs/guides/platforms.md) | How operating systems and virtual environments share new-work decisions |
| [Security and data/control boundaries](docs/guides/security.md) | Information read, stored, and shared, plus automatic and manual control limits |
| [Test coverage](docs/testing/test-matrix.md) | Product behavior and platforms covered by public tests |
| [Claude Code](docs/guides/usage-claude.md) / [Codex](docs/guides/usage-codex.md) | CLI and Desktop App integration and session behavior |
| [Notifications](docs/guides/notifications.md) | Terminal, OS, Discord, and Telegram delivery |
| [Performance](docs/guides/performance.md) | Background memory use and before-start check time |
| [Security policy](SECURITY.md) | Private vulnerability-reporting route |
| [Contributing](CONTRIBUTING.md) | Change principles and pre-submission checks |
