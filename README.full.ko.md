...
<p align="center">
  <a href="README.full.md">English</a> · <strong>한국어</strong>
</p>
...
[적응형 제동거리](docs/testing/stopping-distance.ko.md)에 있습니다.
...
[아키텍처와 실행 구조](docs/guides/architecture.ko.md)를 참고하십시오.
...
[Codex Desktop App 안내](docs/guides/codex-app.ko.md)에 정리되어 있습니다.
...
- App Server나 CLI가 다른 WSL 배포판·가상 머신·격리 컨테이너에서 실행되면 그 환경마다
  ...
  [플랫폼과 여러 환경의 연동 방식](docs/guides/platforms.ko.md)에 있습니다.
...
사용합니다. 자세한 측정 조건과 원자료는 [성능 측정](docs/guides/performance.ko.md)에 있습니다.
...
묶지는 않습니다. 설정 방법은
[플랫폼과 여러 환경의 연동 방식](docs/guides/platforms.ko.md)을 참고하십시오.
...
[알림 설정](docs/guides/notifications.ko.md)에 있습니다.
...
[Claude Code 사용 안내](docs/guides/usage-claude.ko.md)와 [Codex 사용 안내](docs/guides/usage-codex.ko.md)에 있습니다.
...
[보안과 데이터·제어 경계](docs/guides/security.ko.md)에 자세히 정리했습니다.
...
[테스트 범위](docs/testing/test-matrix.ko.md)에 있습니다.

## 문서

| 안내서 | 용도 |
| --- | --- |
| [문서 전체 보기](docs/README.ko.md) | 설치·사용 안내, 보안 경계와 공개 테스트 문서 찾기 |
| [아키텍처](docs/guides/architecture.ko.md) | 백그라운드 감시, 실행 전 검사, 상태 파일, 프로그램 제어 구조 |
| [Codex Desktop App](docs/guides/codex-app.ko.md) | 공유 App Server의 논리 대화 구분, blind 제어와 복구 |
| [적응형 제동거리](docs/testing/stopping-distance.ko.md) | 제동 계산식, 실제 수치, 단계적 감속과 회복 결과 |
| [플랫폼과 여러 환경 연동](docs/guides/platforms.ko.md) | 여러 운영체제와 가상 환경이 새 작업 허용 상태를 공유하는 방식 |
| [보안과 데이터·제어 경계](docs/guides/security.ko.md) | 확인·저장·공유 정보와 자동·수동 제어의 한계 |
| [테스트 범위](docs/testing/test-matrix.ko.md) | 공개 테스트가 확인하는 기능과 플랫폼 |
| [Claude Code](docs/guides/usage-claude.ko.md) / [Codex](docs/guides/usage-codex.ko.md) | CLI와 Desktop App 연결 설정·세션 동작 |
| [알림](docs/guides/notifications.ko.md) | 터미널·OS·Discord·Telegram 전달 |
| [성능](docs/guides/performance.ko.md) | 백그라운드 메모리 사용량과 실행 전 검사 시간 |
| [보안 정책](SECURITY.ko.md) | 취약점 비공개 제보 방법 |
| [기여 방법](CONTRIBUTING.ko.md) | 변경 원칙과 제출 전 검사 |
